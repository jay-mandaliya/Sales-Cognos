...
with open(Path("../data/clean_data.csv"), "r") as dataFile:
...
with open("../data/order.csv", "w", newline='', encoding='utf-8') as dataFile:
...
with open("../data/date.csv", "w", newline='', encoding='utf-8') as dataFile:
	csvWriter = csv.writer(dataFile)
...
with open("../data/product.csv", "w", newline='', encoding='utf-8') as dataFile:
	csvWriter = csv.writer(dataFile)
...
with open("../data/customer.csv", "w", newline='', encoding='utf-8') as dataFile:
	csvWriter = csv.writer(dataFile)
...
with open("../data/fact_table.csv", "w", newline='', encoding='utf-8') as dataFile:
	csvWriter = csv.writer(dataFile)
